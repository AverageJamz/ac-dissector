...
fields.MsgApplySoundVisualEffectSpeed     = ProtoField.float("ac.msg.apply_snd_vis_fx.param", "Speed")
...
function msgApplySoundVisualEffect(message, tree)
  tree = tree:add("Apply sound/visual effect")

  tree:add_le(fields.MsgApplySoundVisualEffectObject, message(4, 4))
  ...
  local item = tree:add_le(fields.MsgApplySoundVisualEffectEffect, message(8, 4))
  item:append_text(" " .. description)

  tree:add_le(fields.MsgApplySoundVisualEffectSpeed, message(12, 4))
end